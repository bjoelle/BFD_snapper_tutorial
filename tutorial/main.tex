...
Next, we set up our model under the \textbf{Model Parameters} tab Figure~\ref{fig:beauti-mutation}.
...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=1.0\textwidth]{../figures/beauti-mcmc.png}}
...
A new window pops up with the GUI for path sampling/stepping stone analysis similar to Figure~\ref{fig:pathsampler}. 
